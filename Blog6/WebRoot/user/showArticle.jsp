									...
									<tr>
										<td>
											<table width="1000" cellpadding="6" cellspacing="1"
												...
												<s:iterator value="#request.allCriticism" id="cri">
											...
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="showArticleCon.action?id=${requestScope.article.id}&currentPage=1">首页</a>
													<a href="showArticleCon.action?id=${requestScope.article.id}&currentPage=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="showArticleCon.action?id=${requestScope.article.id}&currentPage=${page.currentPage + 1 }">下一页</a>
													<a href="showArticleCon.action?id=${requestScope.article.id}&currentPage=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
											...
											<!-- 添加评论，表单 -->	
											<form action="addCriticism.action" method="post">
									...
									<input type="button" name="cancelButton" value="取消" onClick="history.back()" Class="ButtonCss">
											...
											<table id="noCount" runat="server" width="1000"
												...
												<tr bgcolor="#ffffff" height="50">
													<td align="center">
													<s:property value="#request.article.username" escape="false"/>的博客 
													</td>
												</tr>
											</table>
										</td>
