									...
									<s:iterator value="#request.all" id="article">
										<tr>
											<td bgcolor="#FFFFFF">
												...
												<a href="user/showArticleCon.action?id=<s:property value='#article.id'/>"><s:property value="#article.title"/></a>
													...
													<div align='right' class='smalltxt' height='32px'>
														...
														<!-- 评论与点击数 -->
														|评论(<s:property value="#article.comment"/>)|点击(<s:property value="#article.hasread"/>)|作者:<s:property value='#article.username'/>
													</div> </font>
											</td>
										</tr>
									</s:iterator>
